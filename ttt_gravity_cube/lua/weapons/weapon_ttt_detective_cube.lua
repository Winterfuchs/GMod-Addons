if SERVER then
	...
	resource.AddWorkshop( "1465704494" )
end

local allowDetectives = CreateConVar( "ttt_gc_allow_detective", 1 , {FCVAR_SERVER_CAN_EXECUTE, FCVAR_ARCHIVE, FCVAR_REPLICATED}, "Allow Detectives to buy this Item?" )
...
if allowDetectives:GetBool() then
